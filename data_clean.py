...
COLUMN_RENAME_MAP = {
    ...
    "冠心病（0无，1有）": "CoronaryHeartDisease",
    "高血压（0无，1有）": "Hypertension",
    "外周血管病（0无，1有）": "PeripheralVascularDisease",
    "免疫性疾病（0无，1有）": "ImmuneDisease",
    "糖尿病（0无，1有）": "Diabetes",
    "高脂血症（0无，1有）": "Hyperlipidemia",
    "激素类（0无，1有）": "HormoneUse",
    "吸烟史（0无，1有）": "SmokingHistory",
    "饮酒史（0无，1有）": "AlcoholHistory",
    "BMI分类2": "BMIClass2",
    "BMI分类3": "BMIClass3",
    "病变部位": "LesionSite",
    "病变部位分类2": "LesionSiteClass2",
    "术前前白蛋白PALB": "PreopPALB",
    "术前前白蛋白分类": "PreopPALBClass",
    "术前白蛋白ALB": "PreopALB",
    "术前白蛋白分类": "PreopALBClass",
    "术前血红蛋白HGB": "PreopHGB",
    "术前血红蛋白分类": "PreopHGBClass",
    "术前口咽拭子": "PreopOropharyngealSwab",
    "术前咽拭子分类": "PreopSwabClass",
    "ASA评分": "ASA",
    "ASA评分分类": "ASAClass",
    "术前抗菌药物原始数据": "PreopAntibiotic",
    "术前抗菌药物分类": "PreopAntibioticClass",
    "皮瓣": "Flap",
    "皮瓣分类": "FlapClass",
    "切口感染": "IncisionInfection",
    "肺部感染": "PulmonaryInfection",
    "吻合方式": "AnastomosisMethod",
    "术中输血（有1，无0）": "IntraopTransfusion",
    "颈清扫（0无，1有）": "NeckDissection",
    "术前放疗（0无，1有）": "PreopRadiotherapy",
    "术前化疗（0无，1有）": "PreopChemotherapy",
    "术前同步放化疗": "PreopConcurrentCRT",
    "腔镜（0无，1有）": "Endoscopy",
    "气管造瘘（无0，有1）": "Tracheostomy",
    "术后病理": "PostopPathology",
    "分化": "Differentiation",
    "最新版pTNM": "PTNM",
    "多原发（0否、1是）": "MultiplePrimary",
    "术后03天白蛋白ALB": "PostopDay3ALB",
    "术后03天前白蛋白PALB": "PostopDay3PALB",
    "非计划二次手术": "UnplannedReoperation",
    "吻合口瘘": "AnastomoticFistula",
    "吻合口瘘确认距术后天数": "DaysToFistulaConfirmation",
    "脂肪液化": "FatLiquefaction",
    "是否多重耐药": "MultidrugResistance",
    "年龄分类": "AgeClass",
}
...
PREFERRED_CLASS_COLUMNS = {
    "BMI": "BMIClass3",
    "LesionSite": "LesionSiteClass2",
    "PreopPALB": "PreopPALBClass",
    "PreopALB": "PreopALBClass",
    "PreopHGB": "PreopHGBClass",
    "Flap": "FlapClass",
